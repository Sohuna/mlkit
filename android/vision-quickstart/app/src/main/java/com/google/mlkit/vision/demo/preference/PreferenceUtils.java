...
public class PreferenceUtils {
    ...
    public static int getZoomRate(Context context) {
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
        String prefKey = context.getString(R.string.pref_key_zoom_rate);
        return sharedPreferences.getInt(prefKey, 0);
    }

    public static void setZoomRate(Context context, int zoomNum) {
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
        String prefKey = context.getString(R.string.pref_key_zoom_rate);
        SharedPreferences.Editor editor = sharedPreferences.edit();
        editor.putInt(prefKey, zoomNum);
        editor.commit();
    }
}
